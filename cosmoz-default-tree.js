...
class CosmozDefaultTree extends Cosmoz.Tree {
	constructor(treeData, options = {}) {
		super();
		this._treeData = treeData;
		this._roots = CosmozDefaultTree._objectValues(treeData);
	...
	*/
	 ...
	 * @param {String} pathLocatorSeparator [this.pathLocatorSeparator] (The string which separates the path. e.g ".")
	*/
	getPathStringByProperty(propertyValue, propertyName = this.searchProperty, pathProperty = this.searchProperty, pathStringSeparator = this.pathStringSeparator, pathLocatorSeparator =  this.pathLocatorSeparator) {
		if (propertyValue === undefined) {
			return;
		}
...
Cosmoz.DefaultTree = CosmozDefaultTree;
